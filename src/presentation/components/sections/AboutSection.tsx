...
export default function AboutSection({ info, timeline }: AboutSectionProps) {
  ...
  return (
    <section id="about" className="py-24 px-6" ref={ref}>
      <div className="max-w-4xl mx-auto">
        <SectionTitle title="Sobre" subtitle="Um pouco sobre mim" />
            ...
            <div className="flex gap-10 mt-10 pt-8 border-t border-[var(--border)]">
              {info.stats.map((s) => (
                <div key={s.label}>
                  ...
                  <div
                    className="text-[10px] text-[var(--dim)] mt-0.5"
          ...
          >
            <div className="space-y-6">
              {timeline.map((item, i) => (
                ...
                >
                  <span className="text-[10px] font-mono text-[var(--dim)] pt-1 w-14 shrink-0">
                    {item.year}
                  </span>
                  <div>
